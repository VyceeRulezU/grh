...
const PartnerPage        = lazy(() => import('./modules/about/pages/PartnerPage'));
  ...
  return (
    <div className="app-container">
      <Helmet>
        ...
        <link rel="apple-touch-icon" href="/grh-learn.webp" />
        ...
        <link rel="preconnect" href="https://vedvxjugpwisjshanmyk.supabase.co" />
      </Helmet>
